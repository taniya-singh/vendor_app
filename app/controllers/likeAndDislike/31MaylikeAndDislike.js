...
exports.leftRightSwipe = function(req, res) {
    ...
    if (req.body.to && req.body.from && req.body.reaction && req.body.lat && req.body.lng) {
...
exports.findFriends = function(req, res) {
    ...
    if (req.body.lat && req.body.lng && req.body._id) {
        settingObj.findOne({
                    ...
                    if (err) {
                        ...
                        if (data.length != 0) {
                            ...
                            findObject.latLong = {
                                $geoWithin: {
                                    $centerSphere: [
                                        [req.body.lng, req.body.lat], miles / 3963.2
                                    ]
                                }
                            }
