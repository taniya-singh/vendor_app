...
exports.update_vendor_info2=function(req,res){
 ...
 vendor.update({_id:req.body._id},{$set:{"pickup_time1":req.body.pickup_time1,"pickup_time2":req.body.pickup_time2,"vendor_email":req.body.vendor_email,"password":req.body.password,"vendor_name":req.body.vendor_name,"vendor_address":req.body.vendor_address,"phone_no":req.body.phone_no}},function(err,updatedresponse){
					if(err){
